...
class RakLibInterface implements ServerInstance, AdvancedNetworkInterface{
	...
	public function close(RakLibSession $session, string $reason = "unknown reason"){
	...
	public function sendEncapsulated(string $identifier, string $payload, int $reliability, ?int $orderChannel = null, bool $immediate = false){
